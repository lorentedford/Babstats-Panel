...
if(file_exists($base_folder."templates/start.htm")) {
  $tpl = new phemplate();
  $tpl->set_file("template", $base_folder."templates/start.htm");
...
<div style="visibility:hidden; font-size:xx-small;">modules/start.php 1.0.0</div>