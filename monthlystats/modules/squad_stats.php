...
$query = DBQuery("SELECT $players_table.id FROM $stats_m_table, $players_table, $squads_table $conditions GROUP BY $players_table.squad");
...
<div style="visibility:hidden; font-size:xx-small;">monthlystats/modules/squad_stats.php 1.0.0</div>