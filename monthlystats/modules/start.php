...
if(file_exists($base_folder."monthlystats/templates/start.htm")) {
  $tpl = new phemplate();
  $tpl->set_file("template", $base_folder."monthlystats/templates/start.htm");
...
<div style="visibility:hidden; font-size:xx-small;">monthlystats/modules/start.php 1.0.0</div>